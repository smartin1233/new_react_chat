...
const testAPI = async () => {
  ...
  try {
    ...
    const openaiTest = await fetch('https://api.openai.com/v1/models', {
      headers: {
        'Authorization': 'Bearer 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'
      }
    });
  ...
  try {
    ...
    const openrouterTest = await fetch('https://openrouter.ai/api/v1/models', {
      headers: {
        'Authorization': 'Bearer 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'
      }
    });
