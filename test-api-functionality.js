...
const testAPIFunctionality = async () => {
  ...
  console.log('API Key: sk-proj-FZRvK...A (configured)');
  
  // Test OpenRouter key (should work as fallback)  
  console.log('\n2. Testing OpenRouter API Key:');
  console.log('API Key: sk-or-v1-7592...c92b (configured)');
  console.log('Model: openai/gpt-oss-20b:free');
  
  // Configuration test
  console.log('\n3. Current Configuration:');
  console.log(`{
    "openaiKey": "sk-proj-FZRvK3uB...UGRDXfIIP38ms-qE0yO-Bjo-WquS2xu4DS0A",
    "openrouterKey": "sk-or-v1-7592b1f6...f83d9d28b09c92b",
